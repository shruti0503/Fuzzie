...
import { products } from "@/lib/constants/constants";
    ...
    <main className="">
      ...
      >
        ...
        <div className="absolute inset-0  h-full w-full items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_35%,#223_100%)]">
          ...
          titleComponent={<div className="flex items-center justify-content flex-col">
            <Button size={'lg'}
             className="p-8 mb-8 md:mb-0 text-2xl w-full sm:w-fit border-t-2 rounded-full
             border-[#4D4D4D] bg-[#1F1F1F] hover:bg-white group 
             transition-all flex items-center justify-center gap-4 hover:shadow-xl
     ...
     <InfiniteMovingCards
        className="md:mt-[24rem] mt-[-100px] justify-center  w-full flex"
        items={clients}
        direction="right"
        speed="slow"
      />
